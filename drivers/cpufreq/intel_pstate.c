...
#define INTEL_PSTATE_SAMPLING_INTERVAL	(1 * NSEC_PER_MSEC)

#define INTEL_CPUFREQ_TRANSITION_LATENCY	40000
#define INTEL_CPUFREQ_TRANSITION_DELAY_HWP	8000
#define INTEL_CPUFREQ_TRANSITION_DELAY		240
